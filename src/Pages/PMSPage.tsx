                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <div className="flex gap-2">
                            <input type="number" min="0" max="100" value={emp.management_score??''}
                              onChange={e => update(emp.id, { management_score: parseInt(e.target.value)||null })}
                              placeholder="0–100"
                            ...
                            <button onClick={(e) => { const inp = (e.currentTarget.previousSibling as HTMLInputElement); update(emp.id, { management_score: parseInt(inp.value)||null }); }}
