    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-[#16162a] border border-white/10 rounded-3xl p-7 w-full max-w-lg shadow-2xl">
        ...
        <button
          onClick={save}
          disabled={saving}
          className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white font-bold flex items-center justify-center gap-2 transition disabled:opacity-40"
        >
...
function GoalProgressCard({ goal, onUpdate }: { goal: GoalData; onUpdate: () => void }) {
  ...
  return (
    <>
      <div className="bg-white/3 border border-white/8 rounded-2xl overflow-hidden hover:border-white/15 transition-all">
        {/* Header */}
        <div className="p-5">
        ...
        <div className="border-t border-white/5 px-5 py-3 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-violet-500/15 border border-violet-500/30 text-violet-300 text-xs font-bold hover:bg-violet-500/25 transition"
          >
  ...
  return (
    <div className="p-6 space-y-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Score gauge */}
        <div className="bg-white/3 border border-white/8 rounded-3xl p-6 flex items-center gap-5 md:col-span-1">
          {latestScore ? (
            <>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/3 border border-white/8 rounded-2xl overflow-hidden">
            ...
            <div className="divide-y divide-white/5">
              {[...report.cycles].reverse().map((c: CycleData) => (
                <div key={c.cycle_id} className="px-6 py-4 flex items-center gap-4">
